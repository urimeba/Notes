...
function botonActivo()
{
    ...
    var btnContainer = document.getElementById("menu-lateral");
...
function registrarUsuario()
{
    ...
    if(usuario!="" && contraseña!="" && contraseña2!="" && nombre!="" && apellido!="" && correo!="")
    {
        validacion = correo.split("@")

        if(validacion.length>1 && validacion[1]!="")
        {
            validacion2=validacion[1].split(".")

            if(validacion2.length>1 && validacion2[1]!="")
            {
                // alert("Correo valido")
                ...
                if(contraseña==contraseña2)
                {
                    ...
                    {
                        alert("La contraseña debe ser mayor a seis caracteres")
                    }
